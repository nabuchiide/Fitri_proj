...
$style_row = array(
	...
	$excel -> setActiveSheetIndex(0)->setCellValue('E10', "LAPORAN Transaksi");
    ...
    // Set width kolom
            ...
            header("Content-Disposition: attachment; filename=laporan transaksi $now.xls"); // Set nama file excel nya
