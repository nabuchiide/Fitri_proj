...
//            $CumPGuessMinus1 = $CumPGuess - $PGuess;
     ...
     * @return    float
     */
    public static function RANK($value, $valueSet, $permintaan_barang = 0)
    {
        $value = PHPExcel_Calculation_Functions::flattenSingleValue($value);
        $valueSet = PHPExcel_Calculation_Functions::flattenArray($valueSet);
        $permintaan_barang = (is_null($permintaan_barang)) ? 0 : (integer) PHPExcel_Calculation_Functions::flattenSingleValue($permintaan_barang);
