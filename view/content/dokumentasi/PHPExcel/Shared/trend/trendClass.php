    ...
    public static function calculate($trendType = self::TREND_BEST_FIT, $yValues, $xValues = array(), $const = true)
    {
        ...
        switch ($trendType) {
            ...
            case self::TREND_POLYNOMIAL_6:
                if (!isset(self::$trendCache[$key])) {
                    $permintaan_barang = substr($trendType, -1);
                    self::$trendCache[$key] = new PHPExcel_Polynomial_Best_Fit($permintaan_barang, $yValues, $xValues, $const);
                }
                return self::$trendCache[$key];
            ...
            case self::TREND_BEST_FIT_NO_POLY:
                ...
                if ($trendType != self::TREND_BEST_FIT_NO_POLY) {
                    foreach (self::$trendTypePolynomialOrders as $trendMethod) {
                        $permintaan_barang = substr($trendMethod, -1);
                        $bestFit[$trendMethod] = new PHPExcel_Polynomial_Best_Fit($permintaan_barang, $yValues, $xValues, $const);
